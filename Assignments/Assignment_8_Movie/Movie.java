...
public class Movie {
    ...
    public void createMovieTicket() {
        ...
        // This loop runs as long as the user wants to keep creating tickets
        while (true) {
            ...
            // Ask user whether to continue creating tickets or return to the main menu
            Utility.printAnimated("Would you like to purchase another one? [ y | n ]: ", 200);
            String choice = scanner.nextLine();
